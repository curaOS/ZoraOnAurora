...
import styles from '@styles/components/FullPost.module.scss' // Component styles
...
export default function FullPost({
    ...
    return (
        <div className={styles.showcase__full__post} {...props}>
            ...
            <div>
                ...
                {/* Post time */}
                <span>
                    {dayjs(parseInt(createdAtTimestamp) * 1000).fromNow()}
                </span>
            </div>

                                ...
                                <div>
                                    ...
                                    <div>
                                        <label htmlFor="upload">
                                            ...
                                            <span
                                                className={
                                                    styles.create__upload_required
                                                }
                                            >
                                                (required)
                                            </span>
                                        ...
                                        <span>
                                            Supports common image, video, audio,
                                            and text formats.
                                        </span>
                                        <Dropzone
                                    ...
                                    <div>
                                        ...
                                        <span>
                                            A percentage fee that you receive
                                            for all future sales of this piece.
                                        </span>
                                        <input
                                            id="percentage"
                                            type="number"
                                        ...
                                        {share > 100 || share < 0 ? (
                                            ...
                                            >
                                                Percentage fee must be between
                                                0% - 100%.
                                            </span>
                                        ) : null}
                                    </div>
